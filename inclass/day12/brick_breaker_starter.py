...
class BrickBreakerModel:
    ...
    def __init__(self):
        ...
        self.bricks = []
        #new_brick = Brick(10,10,100,20,(255,0,0)) initial test brick
...
class PyGameBrickBreakerView:
    """Renders the Brick Breaker model to a pygame window"""
...
class PyGameKeyboardController:
    """Maniupulate game state based on keyboard input"""
